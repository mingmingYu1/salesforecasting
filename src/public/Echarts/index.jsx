...
export default React.createClass({
  ...
  contextTypes:{
    ...
    parentCompare: PropTypes.object
  },
  ...
  renderEchartDom() {
    ...
    if (this.context && this.context.parent && this.context.parent.state.echartsConnect) {
      echartObj.group = "group1"
    }
    if (this.context && this.context.parentCompare && this.context.parentCompare.state.echartsConnect) {
      echartObj.group = "group2"
    }
  ...
  render() {
    ...
    let style = this.props.style || {height: '400px'};
